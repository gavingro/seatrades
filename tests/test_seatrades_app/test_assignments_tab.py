...
def test_captains_book_view_sorts_by_camper():
    ...
    result = prepare_assignment_view(df, view="captains_book")
...
def test_cabin_leaders_view_sorts_by_cabin_block_camper():
    ...
    result = prepare_assignment_view(df, view="cabin_leaders")
...
def test_seatrade_leaders_view_sorts_by_block_seatrade_cabin_camper():
    ...
    result = prepare_assignment_view(df, view="seatrade_leaders")
